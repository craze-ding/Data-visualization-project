...
def get_conn():
    # 建立连接
    conn = pymysql.connect(host="xxx.xxx.xxx.xxx",port=3306, user="xxx", password="xxxxxxx", db="cov", charset="utf8")
    # 创建游标
    cursor = conn.cursor()
    return conn, cursor
...
def update_details():
    ...
    try:
        ...
        # 初始化表
        sql_init="TRUNCATE TABLE details"
...
def insert_history():
    ...
    try:
        ...
        sql_init = " TRUNCATE TABLE history"
        cursor.execute(sql_init)
        conn.commit()
...
def get_baidu_hot():
    ...
    # c = brower.find_elements_by_xpath('//*[@id="pl_top_realtimehot"]/table/tbody/tr/td[2]/a')
    c = brower.find_elements_by_xpath('//*[@id="sanRoot"]/main/div[2]/div/div[2]/div')
    # c = brower.find_elements_by_xpath('//*[@id="sanRoot"]/main/div[2]/div/div[2]/div/div[2]/a/div[1]')
...
def update_hotsearch():
    ...
    try:
        ...
        sql_init = "TRUNCATE TABLE hotsearch"
        cursor.execute(sql_init)
        conn.commit()
